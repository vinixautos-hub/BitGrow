...
const COUNTRY_DATA = {
  "Afghanistan":      { code:"+93",  currency:"AFN – Afghan Afghani",       states:{ "Kabul":["Kabul City","Paghman","Mir Bacha Kot"], "Kandahar":["Kandahar City","Spin Boldak","Dand"] } },
  "Albania":          { code:"+355", currency:"ALL – Albanian Lek",          states:{ "Tirana":["Tirana City","Kamëz","Vora"], "Durrës":["Durrës City","Shijak","Krujë"] } },
  "Algeria":          { code:"+213", currency:"DZD – Algerian Dinar",        states:{ "Algiers":["Algiers City","Bab Ezzouar","Dar El Beïda"], "Oran":["Oran City","Es Senia","Bir El Djir"] } },
  "Angola":           { code:"+244", currency:"AOA – Angolan Kwanza",        states:{ "Luanda":["Luanda City","Cacuaco","Belas"], "Huambo":["Huambo City","Caála","Londuimbali"] } },
  "Argentina":        { code:"+54",  currency:"ARS – Argentine Peso",        states:{ "Buenos Aires":["Buenos Aires City","La Plata","Mar del Plata"], "Córdoba":["Córdoba City","Villa Carlos Paz","Río Cuarto"] } },
  "Australia":        { code:"+61",  currency:"AUD – Australian Dollar",     states:{ "New South Wales":["Sydney","Newcastle","Wollongong","Parramatta"], "Victoria":["Melbourne","Geelong","Ballarat","Bendigo"], "Queensland":["Brisbane","Gold Coast","Townsville","Cairns"], "Western Australia":["Perth","Fremantle","Mandurah","Bunbury"] } },
  "Austria":          { code:"+43",  currency:"EUR – Euro",                  states:{ "Vienna":["Vienna City","Floridsdorf","Donaustadt"], "Styria":["Graz","Leoben","Kapfenberg"] } },
  "Bangladesh":       { code:"+880", currency:"BDT – Bangladeshi Taka",     states:{ "Dhaka":["Dhaka City","Narayanganj","Gazipur"], "Chittagong":["Chittagong City","Cox's Bazar","Comilla"] } },
  "Belgium":          { code:"+32",  currency:"EUR – Euro",                  states:{ "Brussels":["Brussels City","Ixelles","Anderlecht"], "Antwerp":["Antwerp City","Mechelen","Turnhout"] } },
  "Brazil":           { code:"+55",  currency:"BRL – Brazilian Real",        states:{ "São Paulo":["São Paulo City","Campinas","Santos","Guarulhos"], "Rio de Janeiro":["Rio de Janeiro City","Niterói","Nova Iguaçu","Duque de Caxias"], "Minas Gerais":["Belo Horizonte","Uberlândia","Contagem","Juiz de Fora"] } },
  "Canada":           { code:"+1",   currency:"CAD – Canadian Dollar",       states:{ "Ontario":["Toronto","Ottawa","Mississauga","Hamilton"], "British Columbia":["Vancouver","Victoria","Kelowna","Abbotsford"], "Quebec":["Montreal","Quebec City","Laval","Gatineau"], "Alberta":["Calgary","Edmonton","Red Deer","Lethbridge"] } },
  "Chile":            { code:"+56",  currency:"CLP – Chilean Peso",          states:{ "Metropolitan Region":["Santiago","Puente Alto","San Bernardo"], "Valparaíso":["Valparaíso City","Viña del Mar","Quilpué"] } },
  "China":            { code:"+86",  currency:"CNY – Chinese Yuan",          states:{ "Beijing":["Beijing City","Chaoyang","Haidian"], "Shanghai":["Shanghai City","Pudong","Minhang"], "Guangdong":["Guangzhou","Shenzhen","Dongguan","Foshan"] } },
  "Colombia":         { code:"+57",  currency:"COP – Colombian Peso",        states:{ "Bogotá":["Bogotá City","Suba","Engativá"], "Antioquia":["Medellín","Bello","Itagüí"] } },
  "Congo":            { code:"+242", currency:"XAF – Central African CFA",   states:{ "Brazzaville":["Brazzaville City","Bacongo","Makélékélé"], "Pointe-Noire":["Pointe-Noire City","Loandjili","Ngoyo"] } },
  "Denmark":          { code:"+45",  currency:"DKK – Danish Krone",          states:{ "Capital Region":["Copenhagen","Frederiksberg","Gentofte"], "Central Denmark":["Aarhus","Silkeborg","Randers"] } },
  "Ecuador":          { code:"+593", currency:"USD – US Dollar",             states:{ "Pichincha":["Quito","Cayambe","Pedro Moncayo"], "Guayas":["Guayaquil","Daule","Milagro"] } },
  "Egypt":            { code:"+20",  currency:"EGP – Egyptian Pound",        states:{ "Cairo":["Cairo City","Heliopolis","Nasr City"], "Alexandria":["Alexandria City","Montaza","Sidi Gaber"] } },
  "Ethiopia":         { code:"+251", currency:"ETB – Ethiopian Birr",        states:{ "Addis Ababa":["Addis Ababa City","Bole","Kolfe Keranio"], "Oromia":["Adama","Jimma","Dire Dawa"] } },
  "Finland":          { code:"+358", currency:"EUR – Euro",                  states:{ "Uusimaa":["Helsinki","Espoo","Vantaa","Tampere"], "Pirkanmaa":["Tampere","Nokia","Ylöjärvi"] } },
  "France":           { code:"+33",  currency:"EUR – Euro",                  states:{ "Île-de-France":["Paris","Boulogne-Billancourt","Saint-Denis"], "Provence-Alpes-Côte d'Azur":["Marseille","Nice","Toulon"] } },
  "Germany":          { code:"+49",  currency:"EUR – Euro",                  states:{ "Bavaria":["Munich","Nuremberg","Augsburg"], "North Rhine-Westphalia":["Cologne","Düsseldorf","Dortmund"], "Berlin":["Berlin City","Mitte","Charlottenburg"] } },
  "Ghana":            { code:"+233", currency:"GHS – Ghanaian Cedi",         states:{ "Greater Accra":["Accra","Tema","Madina","Ashaiman"], "Ashanti":["Kumasi","Obuasi","Ejisu","Bekwai"], "Western":["Sekondi-Takoradi","Tarkwa","Axim"] } },
  "Greece":           { code:"+30",  currency:"EUR – Euro",                  states:{ "Attica":["Athens","Piraeus","Peristeri"], "Central Macedonia":["Thessaloniki","Kalamaria","Oreokastro"] } },
  "Guatemala":        { code:"+502", currency:"GTQ – Guatemalan Quetzal",    states:{ "Guatemala":["Guatemala City","Mixco","Villa Nueva"], "Quetzaltenango":["Quetzaltenango City","Coatepeque","Huehuetenango"] } },
  "Hungary":          { code:"+36",  currency:"HUF – Hungarian Forint",      states:{ "Budapest":["Budapest City","Pest","Buda"], "Pest":["Érd","Dunakeszi","Gödöllő"] } },
  "India":            { code:"+91",  currency:"INR – Indian Rupee",          states:{ "Maharashtra":["Mumbai","Pune","Nagpur","Nashik"], "Karnataka":["Bengaluru","Mysuru","Hubli","Mangaluru"], "Tamil Nadu":["Chennai","Coimbatore","Madurai","Tiruchirappalli"], "Delhi":["New Delhi","Dwarka","Rohini","Janakpuri"] } },
  "Indonesia":        { code:"+62",  currency:"IDR – Indonesian Rupiah",     states:{ "DKI Jakarta":["Jakarta City","North Jakarta","South Jakarta"], "West Java":["Bandung","Bekasi","Bogor","Depok"] } },
  "Iran":             { code:"+98",  currency:"IRR – Iranian Rial",          states:{ "Tehran":["Tehran City","Karaj","Varamin"], "Isfahan":["Isfahan City","Kashan","Najafabad"] } },
  "Iraq":             { code:"+964", currency:"IQD – Iraqi Dinar",           states:{ "Baghdad":["Baghdad City","Sadr City","Al-Karkh"], "Basra":["Basra City","Zubayr","Abu Al-Khasib"] } },
  "Ireland":          { code:"+353", currency:"EUR – Euro",                  states:{ "Leinster":["Dublin","Drogheda","Dundalk"], "Munster":["Cork","Limerick","Waterford"] } },
  "Israel":           { code:"+972", currency:"ILS – Israeli Shekel",        states:{ "Tel Aviv":["Tel Aviv City","Ramat Gan","Bnei Brak"], "Jerusalem":["Jerusalem City","Beit Shemesh","Ma'ale Adumim"] } },
  "Italy":            { code:"+39",  currency:"EUR – Euro",                  states:{ "Lombardy":["Milan","Bergamo","Brescia"], "Lazio":["Rome","Latina","Frosinone"], "Veneto":["Venice","Verona","Padua"] } },
  "Japan":            { code:"+81",  currency:"JPY – Japanese Yen",          states:{ "Tokyo":["Shinjuku","Shibuya","Minato","Chiyoda"], "Osaka":["Osaka City","Sakai","Higashiosaka"], "Kanagawa":["Yokohama","Kawasaki","Sagamihara"] } },
  "Jordan":           { code:"+962", currency:"JOD – Jordanian Dinar",       states:{ "Amman":["Amman City","Zarqa","Russeifa"], "Irbid":["Irbid City","Ar-Ramtha","Bani Kinana"] } },
  "Kazakhstan":       { code:"+7",   currency:"KZT – Kazakhstani Tenge",     states:{ "Almaty":["Almaty City","Medeu","Bostandyq"], "Nur-Sultan":["Nur-Sultan City","Saryarka","Almaty District"] } },
  "Kenya":            { code:"+254", currency:"KES – Kenyan Shilling",       states:{ "Nairobi":["Nairobi City","Westlands","Kasarani","Embakasi"], "Mombasa":["Mombasa City","Mvita","Likoni","Changamwe"], "Kisumu":["Kisumu City","Kisumu East","Kisumu West"] } },
  "Kuwait":           { code:"+965", currency:"KWD – Kuwaiti Dinar",         states:{ "Capital":["Kuwait City","Salmiya","Hawalli"], "Ahmadi":["Ahmadi City","Fahaheel","Fintas"] } },
  "Lebanon":          { code:"+961", currency:"LBP – Lebanese Pound",        states:{ "Beirut":["Beirut City","Ashrafieh","Hamra"], "Mount Lebanon":["Jounieh","Baabda","Aley"] } },
  "Libya":            { code:"+218", currency:"LYD – Libyan Dinar",          states:{ "Tripoli":["Tripoli City","Tajoura","Ain Zara"], "Benghazi":["Benghazi City","Al-Sabri","Qwarsha"] } },
  "Malaysia":         { code:"+60",  currency:"MYR – Malaysian Ringgit",     states:{ "Kuala Lumpur":["Kuala Lumpur City","Chow Kit","Brickfields"], "Selangor":["Shah Alam","Petaling Jaya","Klang","Subang Jaya"] } },
  "Mexico":           { code:"+52",  currency:"MXN – Mexican Peso",          states:{ "Mexico City":["Cuauhtémoc","Iztapalapa","Gustavo A. Madero"], "Jalisco":["Guadalajara","Zapopan","Tlaquepaque"] } },
  "Morocco":          { code:"+212", currency:"MAD – Moroccan Dirham",       states:{ "Casablanca-Settat":["Casablanca","Mohammedia","El Jadida"], "Rabat-Salé-Kénitra":["Rabat","Salé","Kenitra"] } },
  "Mozambique":       { code:"+258", currency:"MZN – Mozambican Metical",    states:{ "Maputo":["Maputo City","Matola","Boane"], "Sofala":["Beira","Dondo","Buzi"] } },
  "Myanmar":          { code:"+95",  currency:"MMK – Myanmar Kyat",          states:{ "Yangon":["Yangon City","Hlaing","Tamwe"], "Mandalay":["Mandalay City","Pyin Oo Lwin","Meiktila"] } },
  "Netherlands":      { code:"+31",  currency:"EUR – Euro",                  states:{ "North Holland":["Amsterdam","Haarlem","Alkmaar"], "South Holland":["Rotterdam","The Hague","Leiden"] } },
  "New Zealand":      { code:"+64",  currency:"NZD – New Zealand Dollar",    states:{ "Auckland":["Auckland City","Manukau","North Shore","Waitakere"], "Wellington":["Wellington City","Lower Hutt","Upper Hutt","Porirua"] } },
  "Nigeria":          { code:"+234", currency:"NGN – Nigerian Naira",        states:{ "Lagos":["Ikeja","Victoria Island","Lekki","Surulere","Ikorodu","Badagry","Eti-Osa","Agege","Alimosho","Ajeromi-Ifelodun"], "Abuja (FCT)":["Garki","Wuse","Maitama","Asokoro","Gwarinpa","Kubwa","Kuje","Bwari"], "Rivers":["Port Harcourt","Obio-Akpor","Eleme","Ikwerre","Oyigbo"], "Kano":["Kano Municipal","Fagge","Dala","Gwale","Tarauni"], "Oyo":["Ibadan North","Ibadan South-East","Egbeda","Oluyole","Akinyele"], "Anambra":["Awka","Onitsha","Nnewi","Ekwusigo","Ogbaru"], "Kaduna":["Kaduna North","Kaduna South","Chikun","Igabi","Zaria"] } },
  "Norway":           { code:"+47",  currency:"NOK – Norwegian Krone",       states:{ "Oslo":["Oslo City","Grünerløkka","Frogner"], "Viken":["Drammen","Fredrikstad","Sarpsborg"] } },
  "Pakistan":         { code:"+92",  currency:"PKR – Pakistani Rupee",       states:{ "Punjab":["Lahore","Faisalabad","Rawalpindi","Multan"], "Sindh":["Karachi","Hyderabad","Sukkur","Larkana"], "Islamabad":["Islamabad City","G-10","F-7","I-8"] } },
  "Peru":             { code:"+51",  currency:"PEN – Peruvian Sol",          states:{ "Lima":["Lima City","Miraflores","San Isidro"], "Arequipa":["Arequipa City","Cayma","Cerro Colorado"] } },
  "Philippines":      { code:"+63",  currency:"PHP – Philippine Peso",       states:{ "Metro Manila":["Manila","Quezon City","Makati","Pasig"], "Cebu":["Cebu City","Mandaue","Lapu-Lapu","Talisay"] } },
  "Poland":           { code:"+48",  currency:"PLN – Polish Zloty",          states:{ "Masovian":["Warsaw","Radom","Płock"], "Silesian":["Katowice","Częstochowa","Sosnowiec"] } },
  "Portugal":         { code:"+351", currency:"EUR – Euro",                  states:{ "Lisbon":["Lisbon City","Sintra","Amadora"], "Porto":["Porto City","Gaia","Braga"] } },
  "Qatar":            { code:"+974", currency:"QAR – Qatari Riyal",          states:{ "Ad Dawhah":["Doha City","Al Wakrah","Al Khor"], "Al Rayyan":["Al Rayyan City","Umm Salal","Al Daayen"] } },
  "Romania":          { code:"+40",  currency:"RON – Romanian Leu",          states:{ "Bucharest":["Bucharest City","Sector 1","Sector 2"], "Cluj":["Cluj-Napoca","Dej","Turda"] } },
  "Russia":           { code:"+7",   currency:"RUB – Russian Ruble",         states:{ "Moscow":["Moscow City","Zelenograd","Troitsk"], "Saint Petersburg":["Saint Petersburg City","Peterhof","Kolpino"] } },
  "Saudi Arabia":     { code:"+966", currency:"SAR – Saudi Riyal",           states:{ "Riyadh":["Riyadh City","Diriyah","Al Kharj"], "Makkah":["Mecca","Jeddah","Taif"] } },
  "Senegal":          { code:"+221", currency:"XOF – West African CFA",      states:{ "Dakar":["Dakar City","Pikine","Guédiawaye"], "Thiès":["Thiès City","Mbour","Tivaouane"] } },
  "Singapore":        { code:"+65",  currency:"SGD – Singapore Dollar",      states:{ "Central Region":["Downtown Core","Orchard","Rochor"], "West Region":["Clementi","Jurong East","Buona Vista"] } },
  "South Africa":     { code:"+27",  currency:"ZAR – South African Rand",    states:{ "Gauteng":["Johannesburg","Pretoria","Ekurhuleni","Tshwane"], "Western Cape":["Cape Town","Stellenbosch","George","Paarl"], "KwaZulu-Natal":["Durban","Pietermaritzburg","Richards Bay","Newcastle"] } },
  "South Korea":      { code:"+82",  currency:"KRW – South Korean Won",      states:{ "Seoul":["Seoul City","Gangnam","Mapo","Jongno"], "Busan":["Busan City","Haeundae","Nam","Dong"] } },
  "Spain":            { code:"+34",  currency:"EUR – Euro",                  states:{ "Community of Madrid":["Madrid","Móstoles","Alcalá de Henares"], "Catalonia":["Barcelona","Hospitalet","Badalona"] } },
  "Sri Lanka":        { code:"+94",  currency:"LKR – Sri Lankan Rupee",      states:{ "Western":["Colombo","Sri Jayawardenepura Kotte","Dehiwala"], "Central":["Kandy","Matale","Nuwara Eliya"] } },
  "Sudan":            { code:"+249", currency:"SDG – Sudanese Pound",        states:{ "Khartoum":["Khartoum City","Omdurman","Khartoum North"], "Darfur":["El Fasher","Nyala","El Geneina"] } },
  "Sweden":           { code:"+46",  currency:"SEK – Swedish Krona",         states:{ "Stockholm":["Stockholm City","Södertälje","Nacka"], "Västra Götaland":["Gothenburg","Borås","Mölndal"] } },
  "Switzerland":      { code:"+41",  currency:"CHF – Swiss Franc",           states:{ "Zurich":["Zurich City","Winterthur","Uster"], "Bern":["Bern City","Biel/Bienne","Thun"] } },
  "Syria":            { code:"+963", currency:"SYP – Syrian Pound",          states:{ "Damascus":["Damascus City","Kafr Sousa","Mezzeh"], "Aleppo":["Aleppo City","Al-Bab","Azaz"] } },
  "Tanzania":         { code:"+255", currency:"TZS – Tanzanian Shilling",    states:{ "Dar es Salaam":["Kinondoni","Ilala","Temeke","Ubungo"], "Mwanza":["Ilemela","Nyamagana","Sengerema"] } },
  "Thailand":         { code:"+66",  currency:"THB – Thai Baht",             states:{ "Bangkok":["Bangkok City","Chatuchak","Huai Khwang"], "Chiang Mai":["Chiang Mai City","Doi Saket","Mae Rim"] } },
  "Tunisia":          { code:"+216", currency:"TND – Tunisian Dinar",        states:{ "Tunis":["Tunis City","La Marsa","Ariana"], "Sfax":["Sfax City","Sakiet Ezzit","Thyna"] } },
  "Turkey":           { code:"+90",  currency:"TRY – Turkish Lira",          states:{ "Istanbul":["Fatih","Beyoğlu","Kadıköy","Üsküdar"], "Ankara":["Çankaya","Keçiören","Mamak"] } },
  "Uganda":           { code:"+256", currency:"UGX – Ugandan Shilling",      states:{ "Central":["Kampala","Wakiso","Mukono"], "Eastern":["Jinja","Mbale","Soroti"] } },
  "Ukraine":          { code:"+380", currency:"UAH – Ukrainian Hryvnia",     states:{ "Kyiv":["Kyiv City","Boryspil","Brovary"], "Kharkiv":["Kharkiv City","Lozova","Chuhuiv"] } },
  "United Arab Emirates": { code:"+971", currency:"AED – UAE Dirham",        states:{ "Dubai":["Deira","Bur Dubai","Jumeirah","Downtown Dubai"], "Abu Dhabi":["Abu Dhabi City","Al Ain","Khalifa City"], "Sharjah":["Sharjah City","Al Qasimia","Al Nahda"] } },
  "United Kingdom":   { code:"+44",  currency:"GBP – British Pound",         states:{ "England":["London","Manchester","Birmingham","Leeds","Liverpool"], "Scotland":["Edinburgh","Glasgow","Aberdeen","Dundee"], "Wales":["Cardiff","Swansea","Newport","Wrexham"] } },
  "United States":    { code:"+1",   currency:"USD – US Dollar",             states:{ "California":["Los Angeles","San Francisco","San Diego","Sacramento","San Jose"], "Texas":["Houston","Dallas","Austin","San Antonio","Fort Worth"], "New York":["New York City","Buffalo","Rochester","Syracuse","Albany"], "Florida":["Miami","Orlando","Tampa","Jacksonville","Fort Lauderdale"], "Illinois":["Chicago","Aurora","Naperville","Joliet","Rockford"] } },
  "Venezuela":        { code:"+58",  currency:"VES – Venezuelan Bolívar",    states:{ "Capital":["Caracas","Petare","El Hatillo"], "Zulia":["Maracaibo","Cabimas","Ciudad Ojeda"] } },
  "Vietnam":          { code:"+84",  currency:"VND – Vietnamese Dong",       states:{ "Hanoi":["Hoan Kiem","Dong Da","Ba Dinh"], "Ho Chi Minh City":["District 1","Binh Thanh","Tan Binh"] } },
  "Yemen":            { code:"+967", currency:"YER – Yemeni Rial",           states:{ "Sana'a":["Sana'a City","Shu'ub","Ma'ain"], "Aden":["Aden City","Al-Mualla","Tawahi"] } },
  "Zambia":           { code:"+260", currency:"ZMW – Zambian Kwacha",        states:{ "Lusaka":["Lusaka City","Chilanga","Kafue"], "Copperbelt":["Ndola","Kitwe","Chingola"] } },
  "Zimbabwe":         { code:"+263", currency:"ZWL – Zimbabwean Dollar",     states:{ "Harare":["Harare City","Chitungwiza","Epworth"], "Bulawayo":["Bulawayo City","Nkulumane","Pelandaba"] } },
};

// Currency → Country reverse map
